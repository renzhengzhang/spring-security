 ...
 * 
 * <p>
 * 身份认证成功之后，需要删除 CsrfTokenRepository 中保存的 CsrfToken，并重新生成
 * 
 * @author Rob Winch
...
public final class CsrfAuthenticationStrategy implements SessionAuthenticationStrategy {
	...
	public void onAuthentication(Authentication authentication, HttpServletRequest request,
		...
		// 判断请求 Session 或者请求 Cookie 中是否包含 CsrfToken
		boolean containsToken = this.tokenRepository.loadToken(request) != null;

		// 若请求携带 CsrfToken，则需要删除，并重新生成（延迟生成，延迟保存至 tokenRepository 中）放入请求属性中
		if (containsToken) {
